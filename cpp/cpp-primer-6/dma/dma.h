...
// This common requirement is accomplished three different ways. For a destructor
// it is done automatically. For a constructor, it is accomplished by invoking
// the base-class copy constructor in the memory initialization list, or else
// the default constructor is invoked automatically. For the assignment operator,
// it is accomplished by using the scope-resolution operator in an explicit call
// of the base-class assignment operator.
#ifndef DMA_H_
#define DMA_H_
