/*
 * Complete the function which get an input number n such that n >= 10 and
 * n < 10000, then:
 * 1. Sum all the digits of n.
 * 2. Subtract the sum from n, and it is your new n.
 * 3. If the new n is in the list below return the associated fruit, otherwise
