...
int main(int argc, char *argv[])
{
    ...
    if (argc != 2) {
        printf("Usage: %s <staring-pathname>\n", argv[0]);
        return -1;
    }
...
/**
 * descend throgh the hierarchy, starting at "pathname".
 ...
 * call func(), and return. FOr a directory, we cal ourself
